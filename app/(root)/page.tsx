  ...
  return (
    <main className="flex flex-col gap-20">
      ...
      <div className="flex flex-col -mt-20">
        {/* HERO SECTION */}
        <section className="bg-black md:bg-[url('/bg/main-hero.png')] bg-[url('/bg/main-hero-mobile-1.jpeg')] bg-cover bg-top h-screen flex flex-col justify-center items-center text-center text-white pt-40 pb-40 relative gap-5">
